...
contract Screwball is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Screwball", "SCREWBALL", 9) ERC20Permit() {
    ...
    /**
        @notice increases SCREWBALL supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SCREWBALL
